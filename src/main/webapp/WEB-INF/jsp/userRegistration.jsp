...
<body background="img4.jpg" background-size="100">
	...
	<form class="form-horizontal" action="userRegistration.html"
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" style="color: tan;">Gender <small style="color:red">(optional)</small></label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" style="color: tan;">Date of Birth <small style="color:red">(optional)</small></label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" style="color: tan;">Citizenship <small style="color:red">(optional)</small></label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" style="color: tan;">Phone Number <small style="color:red">(optional)</small></label>
			<div class="col-sm-4">
		...
		<input type="hidden" name="typeOfUser" value="student" />
		<input type="Submit"
